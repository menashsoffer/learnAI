...
const KEYBOARD_BRAIN = (
  <svg {...box} aria-label="מקלדת מחוברת למוח">
    ...
    <path d="M92 24 c -2 8 -2 14 -6 18 c 4 3 4 9 1 13 c 4 2 8 1 9 -3" strokeWidth="2" opacity="0.7" />
  </svg>
);
...
const CRAZY_COMPUTER = (
  <svg {...box} aria-label="מחשב משוגע">
    ...
    <path d="M64 46 c 12 0 18 10 16 19 c -2 9 -14 13 -21 7 c -6 -5 -6 -15 2 -18 c 6 -2 12 3 11 9" className="ill-accent" />
    <path d="M32 28 c 3 -4 3 -8 0 -12 M44 24 c 3 -4 3 -8 0 -12" className="ill-accent" strokeWidth="2.5" />
